...
def get_vault_root() -> Path:
    ...
    if env:
        return Path(env)
    return Path.home() / "Documents" / "Vaults" / "MyVault"
...
def append_to_daily_log(project: str, messages: list[str], date: str):
    ...
    The daily log lives at ~/Documents/Vaults/MyVault/Work/Claude Code/Daily Logs/YYYY-MM-DD.md
    ...
    """
    vault_root = Path.home() / "Documents" / "Vaults" / "MyVault"
